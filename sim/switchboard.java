...
// $Id: switchboard.java,v 1.51 2012/02/25 23:02:46 drmiller Exp $
...
{
	final String ident = "$Id: switchboard.java,v 1.51 2012/02/25 23:02:46 drmiller Exp $";
...
class Kellogg_Properties extends Properties
{
	...
	public Kellogg_Properties() {
		...
		try {
			...
			setProperty("switchboard_host", "localhost:31100");
	...
	implements ActionListener, WindowListener, ComponentListener, HyperlinkListener
{
	...
	public void showAbout() {
		...
		JLabel lab = new JLabel("<HTML><CENTER>"+
				...
				"Simulator<BR>" +
				"$Revision: 1.51 $ $Date: 2012/02/25 23:02:46 $<BR>" +
				"<BR>" +
		...
		implements Runnable, KeyListener, ActionListener, Kellogg_SwListener
{
	...
	public Kellogg_Cabinet(Kellogg_Properties prop,
		...
		// might want to allow "narrow switchboard" option...
		if (_nl < 10) {
			lines_per_row = 5;
			max_circs = 4;
		} else {
